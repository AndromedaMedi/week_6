...
console.log(verdict);
```
<!-- The output will be 'The murder is Miss Scarlet' -->
...
console.log(verdict);
```
<!-- The error messagge will be that 'declareMurderer' has already been defined as a const and therefore cannot be changed later-->
...
console.log(verdict);
```
<!-- The output will be 'The murder is Mrs. White' because although we are assign murderer to 'Colonel Mustard' and later to 'Mr. Green', we called the function plotTwist which reassigns it to 'Mrs. White'-->
